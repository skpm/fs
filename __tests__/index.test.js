const { constants, accessSync, existsSync, mkdirSync, readFileSync, rmdirSync, writeFileSync } = require('../')
...
test('should read a file', (context) => {
  expect(readFileSync(getScriptFolder(context) + '/test/test.txt', 'utf8')).toBe('test')
})
